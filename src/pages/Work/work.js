      ...
      <div className="projects">
        <div className="single">
          ...
          <div className="single-detail">
            ...
            <p>
              <span>Problem:</span> Nigerian businesses across all sectors especially SME's struggle to comply with company legal regulations. <br />
              <span>Solution:</span> Built a platform that will enable these companies at the tap of a button know what regulations apply to their incorporated company without having to afford a lawyer.
            </p>
