      ...
      <div className="menu-toggle">
        ...
        <div className="navigation" ref={elSocials}>
          <div className="large_menu">
            <a className="github" href="https://github.com/MirzaHamad" target="_blank">
            ...
            <a className="linkedin" href="https://www.linkedin.com/in/mirza-hammad-baig-30332b207/" target="_blank">
            ...
            <a className="twitter" href="https://twitter.com/mirzahamad123" target="_blank">
            ...
            <a className="schedule" href="https://calendly.com/mirzahammadbaig2" target="_blank">
          ...
          <div className="small_menu">
            <ul>
              ...
              <li className="menu-four">
                <a className="nav-link" href="https://drive.google.com/file/d/1K1ZVd9Vcl9mUlNer9S6knKYfD10whLQz/view?usp=sharing" target="_blank">
                  Resume
                </a>
              </li>
              <li className="menu-five">
                <a className="nav-link" href="mailto:mirzahammadbaig2@gmail.com" target="_blank">
                  Contact
                </a>
              </li>
            </ul>
